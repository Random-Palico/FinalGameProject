...
public class Monster : MonoBehaviour
{
    ...
    public ItemDrop[] itemDrops;// Prefab of the item to be dropped on death

    public int pointsOnDeath = 10;
    public int moneysOnDeath = 10;
    void Start()
    {
    ...
    public void TakeDamage(int takedamage)
    {
        ...
        {// Check if this line gets logged
            ...
            Money.instance.AddMoney(pointsOnDeath);
    ...
    {
        if (itemDrops.Length == 0) return; // No items to drop
